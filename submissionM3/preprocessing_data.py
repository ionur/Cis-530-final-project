...
def find_sent_nltk_format_v1(inputFile, ner_tags_ann_dict):
	...
	# with open("/Users/bhavnasaluja/Desktop/ner_train_data1.txt", 'w') as fout:
	# 		for word in list_of_words:
	# 			fout.write('{}'.format(word))
	# 			fout.write('\n')

	# with open("/Users/bhavnasaluja/Desktop/ner_train_labels1.txt", 'w') as fout:
...
def create_ner_type_data_for_train(inputFile, ner_tags_ann_list):
	...
	with open(inputFile, 'r') as f:
		for line in f:	
			...
			for word, label, startIndex in zip(list_of_words, list_of_labels, index_of_words_in_train_line):
				sent_list.append((word, label, startIndex))
			outer_list.append(sent_list)

	# with open("/Users/bhavnasaluja/Desktop/ner_train_Version2.txt", 'w') as fout:
	# 		for word, label in zip(list_of_words, list_of_labels):
	# 			fout.write('{}'.format((word, label)))
	# 			fout.write('\n')
